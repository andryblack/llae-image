...
META_OBJECT_INFO(image::ImageCompose,meta::object)
...
namespace image {
	...
	class ImageCompose::ComposeWork : public llae::work<ImagePtr> {
	...
	public:
		explicit ComposeWork(const ImageComposePtr& compose) :
			m_compose(compose) {}
	};
